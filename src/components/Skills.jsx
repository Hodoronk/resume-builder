...
function Skill({onDelete}) {
    return(
        <div id ='skill-div'>
            ...
            <button onClick={onDelete} id='delete-button'><img src="src/assets/trash-2.svg" alt="" /></button>
        </div>
    )
}
...
export function Skills() {
    ...
    return (
        <form id="skills-form">
            ...
            <button type="button" onClick={handleAddSkill} id="plus-btn" > <img src="src/assets/plus.svg" alt="" /> </button>
        </form>
    );
}
